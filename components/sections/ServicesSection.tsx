          ...
          <ScrollAnimation animation="slideUp" delay={200}>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-8">
                ...
                <p className="text-lg text-white/95 leading-relaxed mb-6 drop-shadow-md">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white/90 drop-shadow-sm">新品・中古18Kゴールドジュエリー卸売</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">国際輸出入取引サービス</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">長期安定サプライチェーン保証</span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:order-2 bg-black/20 backdrop-blur-sm rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">高品質ダイヤモンド卸売取引</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">透明で合規な取引ルート</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">国際流通ネットワークサポート</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">日本公認金地金代理</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">国際認証金地金販売</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">出所透明、取引安全</span>
                  </div>
                </div>
              </div>
              <div className="aspect-video overflow-hidden rounded-lg border border-border">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:order-2 bg-black/20 backdrop-blur-sm rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">権威機関連携鑑定</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">専門価値評価サービス</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">取引収集価値保証</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">貴金属市場トレンド分析</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">多様化投資配置提案</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">専門投資戦略策定</span>
                  </div>
                </div>
              </div>
              <div className="aspect-video overflow-hidden rounded-lg border border-border">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:order-2 bg-black/20 backdrop-blur-sm rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">高級洋酒収集取引</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">高級時計流通仲介サービス</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">金工芸品価値評価</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-8">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <Badge variant="secondary" className="bg-accent/20 text-accent border-accent/40 backdrop-blur-sm">
                    近日オープン
                  </Badge>
                </div>
                <p className="text-lg text-white/95 leading-relaxed mb-6 drop-shadow-md">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">プライベート高級社交空間</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">金文化テーマ雰囲気</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent rounded-full drop-shadow-sm"></div>
                    <span className="text-white/90 drop-shadow-sm">上品なビジネス交流体験</span>
                  </div>
                </div>
              </div>
              <div className="aspect-video overflow-hidden rounded-lg border border-border">
